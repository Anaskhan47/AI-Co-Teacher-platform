              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setFormData({ ...formData, grade: v, subject: "" })
                    }
                  >
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-3">
              <Button
                ...
                className="h-12 w-12 bg-white border-slate-200 text-slate-400 rounded-2xl hover:text-indigo-600 transition-all"
              >
        ...
        <AnimatePresence mode="wait">
          {paper ? (
              ...
              {activeView === "paper" ? (
                <div className="space-y-12 text-slate-900">
                  <div className="text-center space-y-3 pb-10 border-b border-slate-900/10">
                    <h1 className="text-2xl font-black uppercase tracking-[0.2em] text-slate-900 font-sans">
                      Institutional Examination
                    </h1>
                    <h2 className="text-base font-bold text-slate-600 uppercase font-sans tracking-widest">
                      {paper.title}
                    </h2>
                    <div className="flex justify-between items-end pt-10 font-sans text-[11px] font-black uppercase tracking-[0.15em] text-slate-400">
                      ...
                      <div className="text-right space-y-1.5">
                        <p>
                          Duration:{" "}
                          <span className="text-slate-900">180 Minutes</span>
                        </p>
                        <p>
                          Max. Marks:{" "}
                          <span className="text-slate-900">
                      ...
                      <div key={idx} className="space-y-8">
                        ...
                        <div className="space-y-10">
                          {section.questions.map((q: any, qIdx: number) => (
                            <div
                              key={qIdx}
                              className="flex items-start justify-between gap-8 group"
                            >
                              <div className="flex gap-6 flex-1">
                                <span className="font-bold text-slate-900 text-sm min-w-[2rem] font-sans">
                                  Q{qIdx + 1}.
                                </span>
                                    ...
                                    <div className="grid grid-cols-2 gap-x-12 gap-y-4 pt-2">
                                      {q.options.map(
                                        (opt: string, optIdx: number) => (
                                          <div
                                            key={optIdx}
                                            className="text-xs text-slate-700 flex items-start gap-4 font-sans"
                                          >
                ...
                <div className="space-y-12 text-slate-900 font-sans">
                  ...
                  <div className="space-y-10">
                    <div className="space-y-6">
                      <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-600 border-l-4 border-indigo-600 pl-4">
                      ...
                      <div className="grid gap-4">
                        {Object.entries(paper.answerKey || {}).map(
                          ([qId, ans]: any) => (
                            <div
                              key={qId}
                              className="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex gap-6 items-start transition-all hover:bg-indigo-50/30"
                            >
                              <div className="w-10 h-10 rounded-xl bg-white border border-indigo-100 text-indigo-600 flex items-center justify-center font-black shrink-0 text-sm shadow-sm">
                                {qId}
                              </div>
            ...
            <div className="flex flex-col items-center justify-center py-40 text-center animate-in fade-in zoom-in duration-700">
              ...
              <h3 className="font-black text-2xl text-slate-900 tracking-tight uppercase">
                Ready for Synthesis
              </h3>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-4 max-w-xs leading-loose">
                Define the pedagogical scope in the configuration panel to
                generate institutional grade assessments
              </p>
            </div>
          )}
        </AnimatePresence>
